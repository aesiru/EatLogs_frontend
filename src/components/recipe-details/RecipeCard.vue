...
<template>
  <div class="flex flex-col flex-end card-container group">
    <RouterLink :to="`/recipe/${id}`" class="block mb-5 overflow-hidden rounded-xl">
      <img :src="image" alt="" class="w-[15.2rem] h-[12.6rem] object-cover transition-transform duration-200 hover:scale-105" />
    </RouterLink>

    <div class="flex flex-row justify-between">
      <div class="flex flex-col">
        <p class="label1 group-hover:text-[#535E3F] transition-colors duration-200">{{ recipe_name }}</p>
      ...
      <div class="flex flex-row items-center gap-1">
        ...
        <RouterLink 
          ...
          class="cursor-pointer hover:scale-110 transition-transform duration-150"
        >
          <img src="/src/assets/icons/edit-icon.svg" alt="Edit" class="w-[1.25rem] h-[1.25rem]" />
        </RouterLink>
        <img 
          src="/src/assets/icons/delete-icon.svg" 
          alt="Delete" 
          class="w-[1.25rem] h-[1.25rem] cursor-pointer hover:scale-110 transition-transform duration-150"
