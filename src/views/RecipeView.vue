...
<template>
  <div class="bg-[#F5ECD5] min-h-screen p-10">
    ...
    <p class="font-satisfy text-7xl text-[#626F47] custom-text-shadow-2 text-center mt-5">Let's Eat Logs!</p>
      ...
      <div class="flex flex-col mt-10 gap-2">
        <!-- categs -->
         ...
         <label class="flex items-center gap-2">
          <input type="checkbox" v-model="isChecked" fill="none" class="w-[1.5rem] h-[1.5rem] border-2 border-[#626F47] rounded-[2rem] checked:bg-[#626F47] accent-[#626F47]"/>
          Cats 1
        </label>
         <label class="flex items-center gap-2">
          <input type="checkbox" v-model="isChecked" fill="none" class="w-[1.5rem] h-[1.5rem] border-2 border-[#626F47] rounded-[2rem] checked:bg-[#626F47] accent-[#626F47]"/>
