...
<template>
  <div class="flex flex-col bg-[#626F47] md:flex-row h-auto md:h-screen">
  <img src="/src/assets/pictures/home-img.png" alt="home-img" className="w-full md:w-1/2 h-64 md:h-full object-cover object-left">
