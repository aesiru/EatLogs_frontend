...
const currentView = ref('RecipeView')
const views = {
  RecipeView,
  FavoritesView
}
...
<template>
    <div class="bg-[#F5ECD5] min-h-screen p-10">
        ...
        <div class="flex flex-row gap-10 mt-15 items-start">
            <div class="flex flex-col">
                ...
                <div class="flex flex-col mt-10 gap-2">
                    <!-- cuisines -->
                    <p class="label2">Filter by Cuisine:</p>
                    <label class="flex items-center gap-2">
                    <input
                        type="checkbox"
                        v-model="isCuisineChecked"
                        fill="none"
                        class="w-[1.5rem] h-[1.5rem] border-2 border-[#626F47] rounded-[2rem] checked:bg-[#626F47] accent-[#626F47]"
                    />
                    Cuis 1
            ...
            <div class="flex flex-col w-full">
                <!-- recipes -->
                <div class="flex flex-row justify-between gap-80 items-center">
                    <p v-if="currentView === 'RecipeView'" class="text-[2.5rem] text-[#626F47] font-[700]">Your Recipes</p>
                    <p v-else class="text-[2.5rem] text-[#626F47] font-[700]">Your Favorites</p>
                    <div class="flex flex-row gap-3 text-[#626F47]">
                        <Button
                        v-if="currentView === 'RecipeView'"
                        @click = "currentView = 'FavoritesView'"
