...
<template>
    <div>
        <div class="flex flex-row  items-start w-[38.7rem] min-h-screen bg-[#F0BB78]">
            <div v-if="recipe" class="p-6">
                ...
                <!-- back icon -->
                    ...
                    <div class="">
                        <!-- nore icon -->
                        <button @click="" class="cursor-pointer">
                ...
                <!-- recipe photo, title -->
                <img :src="recipe.image" alt="" class="w-[35rem] h-[32rem] align-middle mt-5">
                <div class="flex flex-row items-center-safe justify-between mt-4">
                    <p class="text-start title1">{{ recipe.recipe_name }}</p>
                    <svg xmlns="http://www.w3.org/2000/svg" width="2.6rem" height="2.2rem" viewBox="0 0 20 16" fill="none">
