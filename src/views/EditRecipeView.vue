...
function handleImageUpload(event: Event) {
  ...
  if (file) {
    ...
    reader.onload = (e) => {
      editedRecipe.value.image = e.target?.result as string
    }
    ...
    <div class="grid md:grid-cols-2 gap-8">
      <div class="space-y-4">
        ...
        <div>
          ...
          <input
            v-model="editedRecipe.recipe_name"
            type="text"
